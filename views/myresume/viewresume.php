...
<div class="content p-rel">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="mt8 mb32"><a href="<?= Url::to(['/myresume'])?>"><?= Html::img('@web/images/blue-left-arrow.svg',['alt' => 'arrow']) ?> Резюме в
                    Кемерово</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-5 mobile-mb32">
                <div class="profile-foto resume-profile-foto"><?= Html::img('@web/images/profile-foto.jpg',['alt' => 'profile-foto']) ?>
                </div>
            </div>
